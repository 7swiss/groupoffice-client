...
}]),angular.module("template/tooltip/tooltip-html-unsafe-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-html-unsafe-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" bind-html-unsafe="content"></div>\n</div>\n')}]),angular.module("template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]),angular.module("template/popover/popover.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/popover/popover.html",'<div class="popover {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-show="title"></h3>\n      <div class="popover-content" ng-bind="content"></div>\n  </div>\n</div>\n')}]),angular.module("template/progressbar/bar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/bar.html",'<div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>')}]),angular.module("template/progressbar/progress.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progress.html",'<div class="progress" ng-transclude></div>')}]),angular.module("template/progressbar/progressbar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progressbar.html",'<div class="progress">\n  <div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>\n</div>')}]),angular.module("template/rating/rating.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/rating/rating.html",'<span ng-mouseleave="reset()" ng-keydown="onKeydown($event)" tabindex="0" role="slider" aria-valuemin="0" aria-valuemax="{{range.length}}" aria-valuenow="{{value}}">\n    <i ng-repeat="r in range track by $index" ng-mouseenter="enter($index + 1)" ng-click="rate($index + 1)" class="glyphicon" ng-class="$index < value && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')">\n        <span class="sr-only">({{ $index < value ? \'*\' : \' \' }})</span>\n    </i>\n</span>')}]),angular.module("template/tabs/tab.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tab.html",'<li ng-class="{active: active, disabled: disabled}">\n  <a ng-click="select()" tab-heading-transclude>{{heading}}</a>\n</li>\n')}]),angular.module("template/tabs/tabset-titles.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset-titles.html","<ul class=\"nav {{type && 'nav-' + type}}\" ng-class=\"{'nav-stacked': vertical}\">\n</ul>\n")}]),angular.module("template/tabs/tabset.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset.html",'\n<div>\n  <ul class="nav nav-{{type || \'tabs\'}}" ng-class="{\'nav-stacked\': vertical, \'nav-justified\': justified}" ng-transclude></ul>\n  <div class="tab-content">\n    <div class="tab-pane" \n         ng-repeat="tab in tabs" \n         ng-class="{active: tab.active}"\n         tab-content-transclude="tab">\n    </div>\n  </div>\n</div>\n')}]),angular.module("template/timepicker/timepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/timepicker/timepicker.html",'<table>\n	<tbody>\n		<tr class="text-center">\n			<td><a ng-click="incrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="incrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n		<tr>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidHours}">\n				<input type="text" ng-model="hours" ng-change="updateHours()" class="form-control text-center" ng-mousewheel="incrementHours()" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td>:</td>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidMinutes}">\n				<input type="text" ng-model="minutes" ng-change="updateMinutes()" class="form-control text-center" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td ng-show="showMeridian"><button type="button" class="btn btn-default text-center" ng-click="toggleMeridian()">{{meridian}}</button></td>\n		</tr>\n		<tr class="text-center">\n			<td><a ng-click="decrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="decrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n	</tbody>\n</table>\n')}]),angular.module("template/typeahead/typeahead-match.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-match.html",'<a tabindex="-1" bind-html-unsafe="match.label | typeaheadHighlight:query"></a>')}]),angular.module("template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-popup.html",'<ul class="dropdown-menu" ng-if="isOpen()" ng-style="{top: position.top+\'px\', left: position.left+\'px\'}" style="display: block;" role="listbox" aria-hidden="{{!isOpen()}}">\n    <li ng-repeat="match in matches track by $index" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index)" role="option" id="{{match.id}}">\n        <div typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>')}]),angular.module("mgcrea.ngStrap.helpers.parseOptions",[]).provider("$parseOptions",function(){var defaults=this.defaults={regexp:/^\s*(.*?)(?:\s+as\s+(.*?))?(?:\s+group\s+by\s+(.*))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+(.*?)(?:\s+track\s+by\s+(.*?))?$/};this.$get=["$parse","$q",function($parse,$q){function ParseOptionsFactory(attr,config){function parseValues(values,scope){return values.map(function(match,index){var label,value,locals={};return locals[valueName]=match,label=displayFn(scope,locals),value=valueFn(scope,locals)||index,{label:label,value:value}})}var $parseOptions={},options=angular.extend({},defaults,config);$parseOptions.$values=[];var match,displayFn,valueName,keyName,groupByFn,valueFn,valuesFn;return $parseOptions.init=function(){$parseOptions.$match=match=attr.match(options.regexp),displayFn=$parse(match[2]||match[1]),valueName=match[4]||match[6],keyName=match[5],groupByFn=$parse(match[3]||""),valueFn=$parse(match[2]?match[1]:valueName),valuesFn=$parse(match[7])},$parseOptions.valuesFn=function(scope,controller){return $q.when(valuesFn(scope,controller)).then(function(values){return $parseOptions.$values=values?parseValues(values,scope):{},$parseOptions.$values})},$parseOptions.init(),$parseOptions}return ParseOptionsFactory}]}),angular.module("mgcrea.ngStrap.tooltip",["mgcrea.ngStrap.helpers.dimensions"]).provider("$tooltip",function(){var defaults=this.defaults={animation:"am-fade",customClass:"",prefixClass:"tooltip",prefixEvent:"tooltip",container:!1,target:!1,placement:"top",template:"tooltip/tooltip.tpl.html",contentTemplate:!1,trigger:"hover focus",keyboard:!1,html:!1,show:!1,title:"",type:"",delay:0};this.$get=["$window","$rootScope","$compile","$q","$templateCache","$http","$animate","dimensions","$$rAF",function($window,$rootScope,$compile,$q,$templateCache,$http,$animate,dimensions,$$rAF){function TooltipFactory(element,config){function getPosition(){return"body"===options.container?dimensions.offset(options.target[0]||element[0]):dimensions.position(options.target[0]||element[0])}function getCalculatedOffset(placement,position,actualWidth,actualHeight){var offset,split=placement.split("-");switch(split[0]){case"right":offset={top:position.top+position.height/2-actualHeight/2,left:position.left+position.width};break;case"bottom":offset={top:position.top+position.height,left:position.left+position.width/2-actualWidth/2};break;case"left":offset={top:position.top+position.height/2-actualHeight/2,left:position.left-actualWidth};break;default:offset={top:position.top-actualHeight,left:position.left+position.width/2-actualWidth/2}}if(!split[1])return offset;if("top"===split[0]||"bottom"===split[0])switch(split[1]){case"left":offset.left=position.left;break;case"right":offset.left=position.left+position.width-actualWidth}else if("left"===split[0]||"right"===split[0])switch(split[1]){case"top":offset.top=position.top-actualHeight;break;case"bottom":offset.top=position.top+position.height}return offset}var $tooltip={},nodeName=element[0].nodeName.toLowerCase(),options=$tooltip.$options=angular.extend({},defaults,config);$tooltip.$promise=fetchTemplate(options.template);var scope=$tooltip.$scope=options.scope&&options.scope.$new()||$rootScope.$new();options.delay&&angular.isString(options.delay)&&(options.delay=parseFloat(options.delay)),options.title&&($tooltip.$scope.title=options.title),scope.$hide=function(){scope.$$postDigest(function(){$tooltip.hide()})},scope.$show=function(){scope.$$postDigest(function(){$tooltip.show()})},scope.$toggle=function(){scope.$$postDigest(function(){$tooltip.toggle()})},$tooltip.$isShown=scope.$isShown=!1;var timeout,hoverState;options.contentTemplate&&($tooltip.$promise=$tooltip.$promise.then(function(template){var templateEl=angular.element(template);return fetchTemplate(options.contentTemplate).then(function(contentTemplate){var contentEl=findElement('[ng-bind="content"]',templateEl[0]);return contentEl.length||(contentEl=findElement('[ng-bind="title"]',templateEl[0])),contentEl.removeAttr("ng-bind").html(contentTemplate),templateEl[0].outerHTML})}));var tipLinker,tipElement,tipTemplate,tipContainer;return $tooltip.$promise.then(function(template){angular.isObject(template)&&(template=template.data),options.html&&(template=template.replace(htmlReplaceRegExp,'ng-bind-html="')),template=trim.apply(template),tipTemplate=template,tipLinker=$compile(template),$tooltip.init()}),$tooltip.init=function(){options.delay&&angular.isNumber(options.delay)&&(options.delay={show:options.delay,hide:options.delay}),"self"===options.container?tipContainer=element:angular.isElement(options.container)?tipContainer=options.container:options.container&&(tipContainer=findElement(options.container));var triggers=options.trigger.split(" ");angular.forEach(triggers,function(trigger){"click"===trigger?element.on("click",$tooltip.toggle):"manual"!==trigger&&(element.on("hover"===trigger?"mouseenter":"focus",$tooltip.enter),element.on("hover"===trigger?"mouseleave":"blur",$tooltip.leave),"button"===nodeName&&"hover"!==trigger&&element.on(isTouch?"touchstart":"mousedown",$tooltip.$onFocusElementMouseDown))}),options.target&&(options.target=angular.isElement(options.target)?options.target:findElement(options.target)[0]),options.show&&scope.$$postDigest(function(){"focus"===options.trigger?element[0].focus():$tooltip.show()})},$tooltip.destroy=function(){for(var triggers=options.trigger.split(" "),i=triggers.length;i--;){var trigger=triggers[i];"click"===trigger?element.off("click",$tooltip.toggle):"manual"!==trigger&&(element.off("hover"===trigger?"mouseenter":"focus",$tooltip.enter),element.off("hover"===trigger?"mouseleave":"blur",$tooltip.leave),"button"===nodeName&&"hover"!==trigger&&element.off(isTouch?"touchstart":"mousedown",$tooltip.$onFocusElementMouseDown))}tipElement&&(tipElement.remove(),tipElement=null),clearTimeout(timeout),scope.$destroy()},$tooltip.enter=function(){return clearTimeout(timeout),hoverState="in",options.delay&&options.delay.show?void(timeout=setTimeout(function(){"in"===hoverState&&$tooltip.show()},options.delay.show)):$tooltip.show()},$tooltip.show=function(){scope.$emit(options.prefixEvent+".show.before",$tooltip);var parent=options.container?tipContainer:null,after=options.container?null:element;tipElement&&tipElement.remove(),tipElement=$tooltip.$element=tipLinker(scope,function(){}),tipElement.css({top:"-9999px",left:"-9999px",display:"block",visibility:"hidden"}).addClass(options.placement),options.animation&&tipElement.addClass(options.animation),options.type&&tipElement.addClass(options.prefixClass+"-"+options.type),options.customClass&&tipElement.addClass(options.customClass),$animate.enter(tipElement,parent,after,function(){scope.$emit(options.prefixEvent+".show",$tooltip)}),$tooltip.$isShown=scope.$isShown=!0,scope.$$phase||scope.$root&&scope.$root.$$phase||scope.$digest(),$$rAF(function(){$tooltip.$applyPlacement(),tipElement.css({visibility:"visible"})}),options.keyboard&&("focus"!==options.trigger?($tooltip.focus(),tipElement.on("keyup",$tooltip.$onKeyUp)):element.on("keyup",$tooltip.$onFocusKeyUp))},$tooltip.leave=function(){return clearTimeout(timeout),hoverState="out",options.delay&&options.delay.hide?void(timeout=setTimeout(function(){"out"===hoverState&&$tooltip.hide()},options.delay.hide)):$tooltip.hide()},$tooltip.hide=function(blur){$tooltip.$isShown&&(scope.$emit(options.prefixEvent+".hide.before",$tooltip),$animate.leave(tipElement,function(){return scope.$emit(options.prefixEvent+".hide",$tooltip),blur&&"focus"===options.trigger?element[0].blur():void 0}),$tooltip.$isShown=scope.$isShown=!1,scope.$$phase||scope.$root&&scope.$root.$$phase||scope.$digest(),options.keyboard&&null!==tipElement&&tipElement.off("keyup",$tooltip.$onKeyUp))},$tooltip.toggle=function(){$tooltip.$isShown?$tooltip.leave():$tooltip.enter()},$tooltip.focus=function(){tipElement[0].focus()},$tooltip.$applyPlacement=function(){if(tipElement){var elementPosition=getPosition(),tipWidth=tipElement.prop("offsetWidth"),tipHeight=tipElement.prop("offsetHeight"),tipPosition=getCalculatedOffset(options.placement,elementPosition,tipWidth,tipHeight);tipPosition.top+="px",tipPosition.left+="px",tipElement.css(tipPosition)}},$tooltip.$onKeyUp=function(evt){27===evt.which&&$tooltip.hide()},$tooltip.$onFocusKeyUp=function(evt){27===evt.which&&element[0].blur()},$tooltip.$onFocusElementMouseDown=function(evt){evt.preventDefault(),evt.stopPropagation(),$tooltip.$isShown?element[0].blur():element[0].focus()},$tooltip}function findElement(query,element){return angular.element((element||document).querySelectorAll(query))}function fetchTemplate(template){return $q.when($templateCache.get(template)||$http.get(template)).then(function(res){return angular.isObject(res)?($templateCache.put(template,res.data),res.data):res})}var trim=String.prototype.trim,isTouch="createTouch"in $window.document,htmlReplaceRegExp=/ng-bind="/gi;return TooltipFactory}]}).directive("bsTooltip",["$window","$location","$sce","$tooltip","$$rAF",function($window,$location,$sce,$tooltip,$$rAF){return{restrict:"EAC",scope:!0,link:function(scope,element,attr){var options={scope:scope};angular.forEach(["template","contentTemplate","placement","container","target","delay","trigger","keyboard","html","animation","type","customClass"],function(key){angular.isDefined(attr[key])&&(options[key]=attr[key])}),angular.forEach(["title"],function(key){attr.$observe(key,function(newValue,oldValue){scope[key]=$sce.trustAsHtml(newValue),angular.isDefined(oldValue)&&$$rAF(function(){tooltip&&tooltip.$applyPlacement()})})}),attr.bsTooltip&&scope.$watch(attr.bsTooltip,function(newValue,oldValue){angular.isObject(newValue)?angular.extend(scope,newValue):scope.title=newValue,angular.isDefined(oldValue)&&$$rAF(function(){tooltip&&tooltip.$applyPlacement()})},!0),attr.bsShow&&scope.$watch(attr.bsShow,function(newValue){tooltip&&angular.isDefined(newValue)&&(angular.isString(newValue)&&(newValue=newValue.match(",?(tooltip),?")),newValue===!0?tooltip.show():tooltip.hide())});var tooltip=$tooltip(element,options);scope.$on("$destroy",function(){tooltip&&tooltip.destroy(),options=null,tooltip=null})}}}]),angular.module("mgcrea.ngStrap.select",["mgcrea.ngStrap.tooltip","mgcrea.ngStrap.helpers.parseOptions"]).provider("$select",function(){var defaults=this.defaults={animation:"am-fade",prefixClass:"select",prefixEvent:"$select",placement:"bottom-left",template:"select/select.tpl.html",trigger:"focus",container:!1,keyboard:!0,html:!1,delay:0,multiple:!1,allNoneButtons:!1,sort:!0,caretHtml:'&nbsp;<span class="caret"></span>',placeholder:"Choose among the following...",maxLength:3,maxLengthHtml:"selected",iconCheckmark:"glyphicon glyphicon-ok"};this.$get=["$window","$document","$rootScope","$tooltip",function($window,$document,$rootScope,$tooltip){function SelectFactory(element,controller,config){var $select={},options=angular.extend({},defaults,config);$select=$tooltip(element,options);var scope=$select.$scope;scope.$matches=[],scope.$activeIndex=0,scope.$isMultiple=options.multiple,scope.$showAllNoneButtons=options.allNoneButtons&&options.multiple,scope.$iconCheckmark=options.iconCheckmark,scope.$activate=function(index){scope.$$postDigest(function(){$select.activate(index)})},scope.$select=function(index){scope.$$postDigest(function(){$select.select(index)})},scope.$isVisible=function(){return $select.$isVisible()},scope.$isActive=function(index){return $select.$isActive(index)},scope.$selectAll=function(){for(var i=0;i<scope.$matches.length;i++)scope.$isActive(i)||scope.$select(i)},scope.$selectNone=function(){for(var i=0;i<scope.$matches.length;i++)scope.$isActive(i)&&scope.$select(i)},$select.update=function(matches){scope.$matches=matches,$select.$updateActiveIndex()},$select.activate=function(index){return options.multiple?(scope.$activeIndex.sort(),$select.$isActive(index)?scope.$activeIndex.splice(scope.$activeIndex.indexOf(index),1):scope.$activeIndex.push(index),options.sort&&scope.$activeIndex.sort()):scope.$activeIndex=index,scope.$activeIndex},$select.select=function(index){var value=scope.$matches[index].value;scope.$apply(function(){$select.activate(index),options.multiple?controller.$setViewValue(scope.$activeIndex.map(function(index){return scope.$matches[index].value})):(controller.$setViewValue(value),$select.hide())}),scope.$emit(options.prefixEvent+".select",value,index)},$select.$updateActiveIndex=function(){controller.$modelValue&&scope.$matches.length?scope.$activeIndex=options.multiple&&angular.isArray(controller.$modelValue)?controller.$modelValue.map(function(value){return $select.$getIndex(value)}):$select.$getIndex(controller.$modelValue):scope.$activeIndex>=scope.$matches.length&&(scope.$activeIndex=options.multiple?[]:0)},$select.$isVisible=function(){return options.minLength&&controller?scope.$matches.length&&controller.$viewValue.length>=options.minLength:scope.$matches.length},$select.$isActive=function(index){return options.multiple?-1!==scope.$activeIndex.indexOf(index):scope.$activeIndex===index},$select.$getIndex=function(value){var l=scope.$matches.length,i=l;if(l){for(i=l;i--&&scope.$matches[i].value!==value;);if(!(0>i))return i}},$select.$onMouseDown=function(evt){if(evt.preventDefault(),evt.stopPropagation(),isTouch){var targetEl=angular.element(evt.target);targetEl.triggerHandler("click")}},$select.$onKeyDown=function(evt){if(/(9|13|38|40)/.test(evt.keyCode)){if(evt.preventDefault(),evt.stopPropagation(),!options.multiple&&(13===evt.keyCode||9===evt.keyCode))return $select.select(scope.$activeIndex);38===evt.keyCode&&scope.$activeIndex>0?scope.$activeIndex--:40===evt.keyCode&&scope.$activeIndex<scope.$matches.length-1?scope.$activeIndex++:angular.isUndefined(scope.$activeIndex)&&(scope.$activeIndex=0),scope.$digest()}};var _show=$select.show;$select.show=function(){_show(),options.multiple&&$select.$element.addClass("select-multiple"),setTimeout(function(){$select.$element.on(isTouch?"touchstart":"mousedown",$select.$onMouseDown),options.keyboard&&element.on("keydown",$select.$onKeyDown)})};var _hide=$select.hide;return $select.hide=function(){$select.$element.off(isTouch?"touchstart":"mousedown",$select.$onMouseDown),options.keyboard&&element.off("keydown",$select.$onKeyDown),_hide(!0)},$select}var isNative=(angular.element($window.document.body),/(ip(a|o)d|iphone|android)/gi.test($window.navigator.userAgent)),isTouch="createTouch"in $window.document&&isNative;return SelectFactory.defaults=defaults,SelectFactory}]}).directive("bsSelect",["$window","$parse","$q","$select","$parseOptions",function($window,$parse,$q,$select,$parseOptions){var defaults=$select.defaults;return{restrict:"EAC",require:"ngModel",link:function(scope,element,attr,controller){var options={scope:scope};if(angular.forEach(["placement","container","delay","trigger","keyboard","html","animation","template","placeholder","multiple","allNoneButtons","maxLength","maxLengthHtml"],function(key){angular.isDefined(attr[key])&&(options[key]=attr[key])}),"select"===element[0].nodeName.toLowerCase()){var inputEl=element;inputEl.css("display","none"),element=angular.element('<button type="button" class="btn btn-default"></button>'),inputEl.after(element)}var parsedOptions=$parseOptions(attr.ngOptions),select=$select(element,controller,options),watchedOptions=parsedOptions.$match[7].replace(/\|.+/,"").trim();scope.$watch(watchedOptions,function(){parsedOptions.valuesFn(scope,controller).then(function(values){select.update(values),controller.$render()})},!0),scope.$watch(attr.ngModel,function(){select.$updateActiveIndex(),controller.$render()},!0),controller.$render=function(){var selected,index;options.multiple&&angular.isArray(controller.$modelValue)?(selected=controller.$modelValue.map(function(value){return index=select.$getIndex(value),angular.isDefined(index)?select.$scope.$matches[index].label:!1}).filter(angular.isDefined),selected=selected.length>(options.maxLength||defaults.maxLength)?selected.length+" "+(options.maxLengthHtml||defaults.maxLengthHtml):selected.join(", ")):(index=select.$getIndex(controller.$modelValue),selected=angular.isDefined(index)?select.$scope.$matches[index].label:!1),element.html((selected?selected:attr.placeholder||defaults.placeholder)+defaults.caretHtml)},scope.$on("$destroy",function(){select.destroy(),options=null,select=null})}}}]),angular.module("mgcrea.ngStrap.helpers.dimensions",[]).factory("dimensions",["$document","$window",function(){var fn=(angular.element,{}),nodeName=fn.nodeName=function(element,name){return element.nodeName&&element.nodeName.toLowerCase()===name.toLowerCase()};fn.css=function(element,prop,extra){var value;return value=element.currentStyle?element.currentStyle[prop]:window.getComputedStyle?window.getComputedStyle(element)[prop]:element.style[prop],extra===!0?parseFloat(value)||0:value},fn.offset=function(element){var boxRect=element.getBoundingClientRect(),docElement=element.ownerDocument;return{width:boxRect.width||element.offsetWidth,height:boxRect.height||element.offsetHeight,top:boxRect.top+(window.pageYOffset||docElement.documentElement.scrollTop)-(docElement.documentElement.clientTop||0),left:boxRect.left+(window.pageXOffset||docElement.documentElement.scrollLeft)-(docElement.documentElement.clientLeft||0)}},fn.position=function(element){var offsetParentElement,offset,offsetParentRect={top:0,left:0};return"fixed"===fn.css(element,"position")?offset=element.getBoundingClientRect():(offsetParentElement=offsetParent(element),offset=fn.offset(element),offset=fn.offset(element),nodeName(offsetParentElement,"html")||(offsetParentRect=fn.offset(offsetParentElement)),offsetParentRect.top+=fn.css(offsetParentElement,"borderTopWidth",!0),offsetParentRect.left+=fn.css(offsetParentElement,"borderLeftWidth",!0)),{width:element.offsetWidth,height:element.offsetHeight,top:offset.top-offsetParentRect.top-fn.css(element,"marginTop",!0),left:offset.left-offsetParentRect.left-fn.css(element,"marginLeft",!0)}};var offsetParent=function(element){var docElement=element.ownerDocument,offsetParent=element.offsetParent||docElement;if(nodeName(offsetParent,"#document"))return docElement.documentElement;for(;offsetParent&&!nodeName(offsetParent,"html")&&"static"===fn.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||docElement.documentElement};return fn.height=function(element,outer){var value=element.offsetHeight;return outer?value+=fn.css(element,"marginTop",!0)+fn.css(element,"marginBottom",!0):value-=fn.css(element,"paddingTop",!0)+fn.css(element,"paddingBottom",!0)+fn.css(element,"borderTopWidth",!0)+fn.css(element,"borderBottomWidth",!0),value},fn.width=function(element,outer){var value=element.offsetWidth;return outer?value+=fn.css(element,"marginLeft",!0)+fn.css(element,"marginRight",!0):value-=fn.css(element,"paddingLeft",!0)+fn.css(element,"paddingRight",!0)+fn.css(element,"borderLeftWidth",!0)+fn.css(element,"borderRightWidth",!0),value},fn}]),angular.module("mgcrea.ngStrap.select").run(["$templateCache",function($templateCache){$templateCache.put("select/select.tpl.html",'<ul tabindex="-1" class="select dropdown-menu" ng-show="$isVisible()" role="select"><li ng-if="$showAllNoneButtons"><div class="btn-group" style="margin-bottom: 5px; margin-left: 5px"><button class="btn btn-default btn-xs" ng-click="$selectAll()">All</button> <button class="btn btn-default btn-xs" ng-click="$selectNone()">None</button></div></li><li role="presentation" ng-repeat="match in $matches" ng-class="{active: $isActive($index)}"><a style="cursor: default" role="menuitem" tabindex="-1" ng-click="$select($index, $event)"><span ng-bind="match.label"></span> <i class="{{$iconCheckmark}} pull-right" ng-if="$isMultiple && $isActive($index)"></i></a></li></ul>')}]),angular.module("intermesh.core",[]),angular.module("intermesh.core").filter("apiRoute",["Utils",function(Utils){return function(route,params){return Utils.url(route,params)}}]),angular.module("intermesh.core").directive("autofocus",["$timeout",function($timeout){return{scope:{trigger:"@focus",autofocus:"="},link:function(scope,element){scope.autofocus!==!1&&scope.$watch("trigger",function(){$timeout(function(){element[0].focus()})})}}}]),angular.module("intermesh.core").directive("imMatch",function(){return{require:"ngModel",restrict:"A",scope:{imMatch:"="},link:function(scope,elem,attrs,ctrl){scope.$watch(function(){return ctrl.$pristine&&angular.isUndefined(ctrl.$modelValue)||scope.imMatch===ctrl.$modelValue},function(currentValue){ctrl.$setValidity("imMatch",currentValue)})}}}),angular.module("intermesh.core").filter("t",["Translate",function(Translate){return function(key){return Translate.t(key)}}]),angular.module("intermesh.core").provider("Translate",[function(){var translations={},language="nl";this.setLanguage=function(lang){language=lang},this.addTranslations=function(lang,newTranslations){translations[lang]||(translations[lang]={}),angular.extend(translations[lang],newTranslations)},this.$get=[function(){return{language:language,translations:translations,t:function(text){return this.translations[this.language]&&this.translations[this.language][text]?this.translations[this.language][text]:text}}}]}]),angular.module("intermesh.core").service("Utils",[function(){var Utils=function(){this.baseUrl=localStorage.baseUrl,this.defaultParams=angular.fromJson(sessionStorage.defaultParams)};return Utils.prototype.setBaseUrl=function(url){this.baseUrl=localStorage.baseUrl=url.replace(/^\s+|[\s\/]+$/g,"")+"/"},Utils.prototype.setDefaultParams=function(defaultParams){this.defaultParams=defaultParams,sessionStorage.defaultParams=angular.toJson(defaultParams)},Utils.prototype.url=function(route,params){if(!route&&!params)return this.baseUrl;var url=this.baseUrl+"index.php?r="+route;if(params=params||{},angular.extend(params,this.defaultParams),params)for(var name in params)"string"!=typeof params[name]&&(params[name]=angular.toJson(params[name])),url+="&"+name+"="+encodeURIComponent(params[name]);return url},Utils.prototype.promiseSuccessDecorator=function(promise){promise.success=function(fn){return promise.then(function(response){fn(response)}),promise},promise.error=function(fn){return promise.then(null,function(response){fn(response)}),promise}},new Utils}]),angular.module("intermesh.data",["intermesh.core"]),angular.module("intermesh.data").factory("Model",["$http","$q","$timeout","Utils",function($http,$q,$timeout,Utils){var Model=function(modelName,createRoute,updateRoute,deleteRoute,baseParams){this.modelName=modelName,this.createRoute=createRoute,this.updateRoute=updateRoute,this.deleteRoute=deleteRoute,this.attributes={},this.oldAttributes={},this.idAttribute="id",this.baseParams=baseParams||{},this.init()};return Model.prototype.init=function(){},Model.prototype.getBaseParams=function(){var params=angular.copy(this.baseParams);return this.attributes&&this.attributes[this.idAttribute]&&(params[this.idAttribute]=this.attributes[this.idAttribute]),params},Model.prototype.delete=function(){var deferred=$q.defer();Utils.promiseSuccessDecorator(deferred.promise);var url=Utils.url(this.deleteRoute,this.getBaseParams());return $http.post(url).success(function(result){if(result.success){var data=result.data[this.modelName];data.success?("undefined"!=typeof this.attributes.deleted&&(this.attributes.deleted=!0,this.oldAttributes.deleted=!0),deferred.resolve({model:this,result:result,modelData:data})):deferred.reject({model:this,result:result,modelData:data})}else deferred.reject({model:this,result:result,modelData:data})}.bind(this)),deferred.promise},Model.prototype.unDelete=function(){return this.resetAttributes(),this.attributes.deleted=!1,this.save()},Model.prototype._fixDates=function(attributes){var attr={};for(var attrName in attributes)if(attributes[attrName]instanceof Date){var d=attributes[attrName];attr[attrName]=attributes[attrName].toISOString(),attr[attrName]=0===d.getUTCHours()&&0===d.getUTCMinutes()?attributes[attrName].getUTCFullYear()+"-"+(attributes[attrName].getUTCMonth()+1)+"-"+attributes[attrName].getUTCDate():attributes[attrName].toISOString()}else if(angular.isObject(attributes[attrName])&&attributes[attrName].attributes){var fixed=this._fixDates(attributes[attrName].attributes);attr[attrName]={attributes:fixed}}else attr[attrName]=attributes[attrName];return attr},Model.prototype.isModified=function(){return angular.toJson(this.attributes)!==angular.toJson(this.oldAttributes)},Model.prototype.isNew=function(){return this.attributes[this.idAttribute]<1},Model.prototype.getModifiedAttributes=function(attributes,oldAttributes){if("undefined"==typeof attributes)var attributes=this.attributes,oldAttributes=this.oldAttributes;var modified=!1;for(var attributeName in attributes){var value=attributes[attributeName];if(angular.isArray(value)){var c=value.length;if(c)for(var i=0,c=value.length;c>i;i++){var attr=this.getModifiedAttributes(value[i].attributes,oldAttributes[attributeName]&&oldAttributes[attributeName][i]?oldAttributes[attributeName][i].attributes:{});attr!==!1&&(modified=this._initModifiedAttributes(modified,attributes),modified[attributeName]||(modified[attributeName]=[]),modified[attributeName].push({attributes:attr}))}}else if(angular.isObject(value)&&value.attributes){var attr=this.getModifiedAttributes(value.attributes,oldAttributes[attributeName]?oldAttributes[attributeName].attributes:{});attr!==!1&&(modified=this._initModifiedAttributes(modified,attributes),modified[attributeName]={attributes:attr})
}else oldAttributes[attributeName]!==value&&(modified=this._initModifiedAttributes(modified,attributes),modified[attributeName]=value)}return modified},Model.prototype._initModifiedAttributes=function(modified,attributes){return modified||(modified={id:attributes.id}),modified},Model.prototype.save=function(getParams){var params=this.getBaseParams();getParams&&angular.extend(params,getParams);var url=this.attributes[this.idAttribute]>0?Utils.url(this.updateRoute,params):Utils.url(this.createRoute,params),deferred=$q.defer();Utils.promiseSuccessDecorator(deferred.promise);var modifiedAttributes=this.getModifiedAttributes();if(modifiedAttributes){var saveParams={};saveParams[this.modelName]={},saveParams[this.modelName].attributes=this._fixDates(modifiedAttributes),$http.post(url,saveParams).success(function(result){var data=result.data[this.modelName];data.success?(this.loadData(data),deferred.resolve({model:this,result:result})):deferred.reject({model:this,result:result,validationErrors:data.validationErrors})}.bind(this))}else deferred.resolve({model:this,result:!1});return deferred.promise},Model.prototype.loadIf=function(id,params){return this.attributes[this.idAttribute]==id?$timeout(function(){}):this.load(id,params)},Model.prototype.resetAttributes=function(){for(var i in this.attributes)delete this.attributes[i];for(var i in this.oldAttributes)this.attributes[i]=angular.copy(this.oldAttributes[i])},Model.prototype.loadData=function(data){for(var key in data)angular.isObject(this[key])?angular.copy(data[key],this[key]):this[key]=data[key];this.oldAttributes=angular.copy(data.attributes)},Model.prototype.load=function(id,params){var p=this.getBaseParams();angular.extend(p,params),id&&(p[this.idAttribute]=id);var url=id>0?Utils.url(this.updateRoute,p):Utils.url(this.createRoute,p);return $http.get(url).success(function(result){result.data&&this.loadData(result.data[this.modelName])}.bind(this))},Model}]),angular.module("intermesh.data").factory("Store",["$http","Utils","Model",function($http,Utils){var Store=function(storeRoute,model,loadParams){this.items=[],this.busy=!1,this.init=!1,this.searchQuery="",this.storeRoute=storeRoute,this.baseModel=model,this.allRecordsLoaded=!1,this.loadParams=loadParams||{},this.defaultLimit=20};return Store.prototype.load=function(params){this.busy=!0,params=params||{};var defaultParams={searchQuery:this.searchQuery,limit:this.defaultLimit,offset:0};return angular.extend(defaultParams,this.loadParams,params),defaultParams.returnAttributes&&(defaultParams.returnAttributes=angular.toJson(defaultParams.returnAttributes)),$http.get(Utils.url(this.storeRoute,defaultParams)).success(function(data){this.allRecordsLoaded=data.results.length<defaultParams.limit,this.loadData(data.results),this.busy=!1,this.init=!0}.bind(this))},Store.prototype.loadData=function(data){for(var i=0;i<data.length;i++){var model=angular.copy(this.baseModel);model.loadData(data[i]),this.items.push(model)}},Store.prototype.nextPage=function(){return this.shouldLoad()?this.load({offset:this.items.length}):!1},Store.prototype.reload=function(){var itemCount=this.items.length<this.defaultLimit?this.defaultLimit:this.items.length;return this.reset(),this.load({limit:itemCount})},Store.prototype.reset=function(keepSearch){keepSearch||(this.searchQuery=""),this.items=[],this.allRecordsLoaded=!1,this.init=!1},Store.prototype.shouldLoad=function(){var ret=!this.busy&&!this.allRecordsLoaded;return ret},Store.prototype.search=function(){return this.reset(!0),this.load()},Store.prototype.searchListener=function($event){13===$event.keyCode&&this.search()},Store.prototype.remove=function(index){return this.total--,this.items.splice(index,1)},Store.prototype.findIndexByAttribute=function(attributeName,value){for(var i=0;i<this.items.length;i++)if(this.items[i].attributes[attributeName]==value)return i;return!1},Store.prototype.saveSortOrder=function(route){for(var sortOrder=[],i=0,max=this.items.length;max>i;i++)sortOrder.push(this.items[i].attributes.id);var params={sortOrder:sortOrder};return $http.post(Utils.url(route),params)},Store.prototype.findModelByAttribute=function(attributeName,value){var i=this.findIndexByAttribute(attributeName,value);return i===!1?!1:this.items[i]},Store}]),angular.module("intermesh.infiniteScroll",[]).directive("imInfiniteScroll",["$timeout",function($timeout){return{scope:{imInfiniteScroll:"&",imInfiniteScrollDisabled:"=",imInfiniteScrollUseDocumentBody:"="},link:function(scope,element,attr){var lengthThreshold=attr.scrollThreshold||50,timeThreshold=attr.timeThreshold||400;lengthThreshold=parseInt(lengthThreshold,10),timeThreshold=parseInt(timeThreshold,10);var scrollEnabled=!0;scope.$watch("imInfiniteScrollDisabled",function(v){scrollEnabled=!v});var scrollEl=attr.imInfiniteScrollUseDocumentBody?window.document.documentElement:element[0],checker=function(){if(!scrollEnabled)return $timeout(checker,timeThreshold);var remaining=scrollEl.scrollHeight-(scrollEl.clientHeight+scrollEl.scrollTop);lengthThreshold>remaining&&(scope.imInfiniteScroll(),$timeout(checker,timeThreshold))};checker(),attr.imInfiniteScrollUseDocumentBody?angular.element(window).bind("scroll",checker):element.bind("scroll",checker)}}}]),angular.module("intermesh.MultiSelectList",["intermesh.core","intermesh.data","intermesh.infiniteScroll","ui.bootstrap"]).factory("MultiSelectList",["$modal","$rootScope","$q",function($modal){var MultiSelectList=function(selectedStore,availableStore,modalTemplateUrl,model,attributeName){this.selectedStore=selectedStore,this.availableStore=availableStore,this.model=model,this.attributeName=attributeName,this.modalTemplateUrl=modalTemplateUrl,this.deleteEnabled=!1};return MultiSelectList.prototype.deleteRecords=function(){if(this.deleteEnabled){for(var i=0;i<this.selectedStore.items.length;i++)this.selectedStore.items[i].attributes.checked&&(this.selectedStore.items[i].attributes.markDeleted=!0);this._updateModel()}this.deleteEnabled=!this.deleteEnabled},MultiSelectList.prototype.ModalInstanceController=function($scope,$modalInstance,multiSelectList){multiSelectList.availableStore.reset(),$scope.multiSelectList=multiSelectList,$scope.ok=function(){for(var selected=[],i=0;i<$scope.multiSelectList.availableStore.items.length;i++)$scope.multiSelectList.availableStore.items[i].attributes.checked&&($scope.multiSelectList.availableStore.items[i].attributes.checked=!1,selected.push($scope.multiSelectList.availableStore.items[i]));$modalInstance.close(selected)},$scope.cancel=function(){$modalInstance.dismiss("cancel")}},MultiSelectList.prototype._updateModel=function(){this.model.attributes[this.attributeName]=this.selectedStore.items},MultiSelectList.prototype.selectRecords=function(){var modalInstance=$modal.open({templateUrl:this.modalTemplateUrl,controller:this.ModalInstanceController,resolve:{multiSelectList:function(){return this}.bind(this)}});return modalInstance.result.then(function(selected){this.selectedStore.items=this.selectedStore.items.concat(selected),this._updateModel()}.bind(this))},MultiSelectList}]),angular.module("intermesh.core").directive("contenteditable",function(){return{require:"ngModel",link:function(scope,element,attrs,ctrl){element.bind("blur",function(){scope.$apply(function(){ctrl.$setViewValue(element.html())})}),ctrl.$render=function(){element.html(ctrl.$viewValue)}}}}),angular.module("intermesh.core").factory("keypressHelper",["$parse",function($parse){var keysByCode={8:"backspace",9:"tab",13:"enter",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"delete"},capitaliseFirstLetter=function(string){return string.charAt(0).toUpperCase()+string.slice(1)};return function(mode,scope,elm,attrs){var params,combinations=[];params=scope.$eval(attrs["im"+capitaliseFirstLetter(mode)]),angular.forEach(params,function(v,k){var combination,expression;expression=$parse(v),angular.forEach(k.split(" "),function(variation){combination={expression:expression,keys:{}},angular.forEach(variation.split("-"),function(value){combination.keys[value]=!0}),combinations.push(combination)})}),elm.bind(mode,function(event){var metaPressed=!(!event.metaKey||event.ctrlKey),altPressed=!!event.altKey,ctrlPressed=!!event.ctrlKey,shiftPressed=!!event.shiftKey,keyCode=event.keyCode;"keypress"===mode&&!shiftPressed&&keyCode>=97&&122>=keyCode&&(keyCode-=32),angular.forEach(combinations,function(combination){var mainKeyPressed=combination.keys[keysByCode[keyCode]]||combination.keys[keyCode.toString()],metaRequired=!!combination.keys.meta,altRequired=!!combination.keys.alt,ctrlRequired=!!combination.keys.ctrl,shiftRequired=!!combination.keys.shift;mainKeyPressed&&metaRequired===metaPressed&&altRequired===altPressed&&ctrlRequired===ctrlPressed&&shiftRequired===shiftPressed&&scope.$apply(function(){combination.expression(scope,{$event:event})})})})}}]),angular.module("intermesh.core").directive("imKeydown",["keypressHelper",function(keypressHelper){return{link:function(scope,elm,attrs){keypressHelper("keydown",scope,elm,attrs)}}}]),angular.module("intermesh.core").directive("imKeypress",["keypressHelper",function(keypressHelper){return{link:function(scope,elm,attrs){keypressHelper("keypress",scope,elm,attrs)}}}]),angular.module("intermesh.core").directive("imKeyup",["keypressHelper",function(keypressHelper){return{link:function(scope,elm,attrs){keypressHelper("keyup",scope,elm,attrs)}}}]),angular.module("intermesh.MultiSelectField",["intermesh.core"]).directive("imMultiSelectField",["$templateCache","$http","Utils",function($templateCache,$http,Utils){return $templateCache.put("imMultiSelectField.html",'<div class="im-multiselect-field form-control">						<ul class="im-multiselect-list">							<li ng-if="!model.attributes.markDeleted" ng-repeat="model in modelAttribute">{{getModelAttributeDisplayName(model)}} <a ng-click="model.attributes.markDeleted=true"><i class="fa fa-trash-o"></i></a></li>						</ul>												<input class="im-multiselect-input" type="text" ng-model="input" placeholder="{{inputPlaceholder}}" typeahead="model as model.typeahead.text for model in getModels()" typeahead-loading="typeaheadLoading" typeahead-on-select="addModel($item, $model, $label)" im-keypress="{13: \'addNewModel($event)\'}">						<i ng-show="typeaheadLoading" class="fa fa-refresh"></i>					</div>'),{restrict:"E",scope:{modelAttribute:"=",modelAttributeDisplayName:"@",inputPlaceholder:"@",storeRoute:"@"},link:function(scope,element,attrs){scope.input="",scope.typeaheadLoading=!1,scope.addModel=function($item){scope.modelAttribute.push($item),scope.input=""},scope.addNewModel=function($event){$event.preventDefault();var value=$event.target.value.trim();""!==value&&scope.modelAttribute.push({attributes:{name:value}}),$event.target.value=""},scope.getModelAttributeDisplayName=function(model){return model.attributes[scope.modelAttributeDisplayName]},scope.getModels=function(){return $http.get(Utils.url(attrs.storeRoute,{searchQuery:scope.input})).then(function(data){for(var i=0;i<data.data.results.length;i++)data.data.results[i].typeahead={text:data.data.results[i].attributes[scope.modelAttributeDisplayName]};return data.data.results})}},templateUrl:"imMultiSelectField.html"}}]),angular.module("intermesh.MessageBox",["intermesh.core","ui.bootstrap"]).controller("MessageBoxModalInstanceCtrl",["$scope","$modalInstance","config",function($scope,$modalInstance,config){$scope.config=config,$scope.form={input:""},$scope.ok=function(){$modalInstance.close($scope.form.input)},$scope.cancel=function(){$modalInstance.dismiss("cancel")}}]).service("MessageBox",["$modal","$templateCache",function($modal,$templateCache){$templateCache.put("intermeshBootstrapMsgAlert.html",'<div ng-if="config.title" class="modal-header"><h3 class="modal-title">{{config.title}}</h3></div><div class="modal-body"><i class="glyphicon glyphicon-{{config.glyphicon}}"></i> {{config.text}}</div><div class="modal-footer"><button class="btn btn-primary" ng-click="ok()" autofocus>{{\'OK\' | t}}</button></div>'),$templateCache.put("intermeshBootstrapMsgConfirm.html",'<div ng-if="config.title" class="modal-header"> 							<h3 class="modal-title">{{config.title}}</h3>						</div>						<div class="modal-body">																					<i class="glyphicon glyphicon-question-sign"></i> {{config.text}}																				</div>						<div class="modal-footer">							<button class="btn btn-primary" ng-click="ok();">{{\'Yes\' | t}}</button>							<button class="btn btn-warning" ng-click="cancel()" autofocus>{{\'No\' | t}}</button>						</div>'),$templateCache.put("intermeshBootstrapMsgPrompt.html",'<form ng-submit="ok()">							<div ng-if="config.title" class="modal-header">								<h3 class="modal-title">{{config.title}}</h3>							</div>							<div class="modal-body">																	<div class="form-goup">									<label>{{config.text}}</label>									<input type="{{config.inputType}}" class="form-control" ng-model="form.input" placeholder="{{config.placeholder}}" required autocomplete="off" autofocus />										</div>															</div>							<div class="modal-footer">								<button class="btn btn-primary" type="submit">{{\'OK\' | t}}</button>								<button class="btn btn-warning" ng-click="cancel()">{{\'Cancel\' | t}}</button>							</div>														</form>');var MessageBox={alert:function(text,title,glyphicon){var config={text:text,title:title,glyphicon:glyphicon||"warning-sign"};return $modal.open({windowClass:"go-modal-alert",templateUrl:"intermeshBootstrapMsgAlert.html",controller:"MessageBoxModalInstanceCtrl",size:"sm",resolve:{config:function(){return config}}})},confirm:function(text,title){var config={text:text,title:title},confirm=$modal.open({windowClass:"go-modal-alert",templateUrl:"intermeshBootstrapMsgConfirm.html",controller:"MessageBoxModalInstanceCtrl",size:"sm",resolve:{config:function(){return config}}});return confirm},prompt:function(text,title,inputType){inputType=inputType||"text";var config={text:text,title:title,inputType:inputType||"text"},prompt=$modal.open({windowClass:"go-modal-alert",templateUrl:"intermeshBootstrapMsgPrompt.html",controller:"MessageBoxModalInstanceCtrl",size:"sm",resolve:{config:function(){return config}}});return prompt}};return MessageBox}]),angular.module("intermesh.ShareModal",["intermesh.core","intermesh.data","intermesh.infiniteScroll"]).factory("ShareModal",["$templateCache","$http","$modal","Store","Model","Utils",function($templateCache,$http,$modal,Store,Model,Utils){$templateCache.put("share-modal.html",'<div class="modal-content">\r\n				 <div class="modal-header">\r\n				 <h3 class="modal-title"><span class="fa fa-share-alt"></span> {{"Share"| t}}</h3>\r\n				 </div>\r\n				 <div class="modal-body">	\r\n				\r\n				<div class="input-group">\r\n					<input type="text" class="form-control" im-keypress="{13: \'shareModal.store.search()\'}" ng-model="shareModal.store.searchQuery" placeholder="{{\'Search\' | t}}..." />\r\n\r\n					<div class="input-group-btn">\r\n\r\n						<button class="btn btn-default" ng-click="shareModal.store.reset();"><i class="fa fa-times"></i></button>\r\n						<button class="btn btn-default" ng-click="shareModal.store.search();"><i class="fa fa-search"></i></button>\r\n					</div>\r\n				</div>\r\n				 \r\n				 <div style="height:300px;overflow:auto" im-infinite-scroll="shareModal.store.nextPage()" im-infinite-scroll-disabled="!shareModal.store.shouldLoad()">\r\n				 \r\n				 <table class="table">\r\n				 <tr>\r\n				 <th></th>\r\n				 <th>\r\n				 {{"Role" | t}}\r\n				 </th>\r\n				 <th style="text-align:center" ng-repeat="permissionAttribute in shareModal.permissionAttributes">\r\n				 {{permissionAttribute.label | t}}\r\n				 </th>					\r\n				 </tr>\r\n				 <tr ng-repeat="model in shareModal.store.items">\r\n				 <td>\r\n				 <i class="fa" ng-class=\'{"fa-user": model.attributes.userId, "fa-group": !model.attributes.userId}\'></i>\r\n				 </td>\r\n				 <td>						\r\n				 {{model.attributes.name}}\r\n				 </td>\r\n				 <td style="text-align:center" ng-repeat="permissionAttribute in shareModal.permissionAttributes">\r\n				 <input type="checkbox" ng-model="model.attributes.permissions.attributes[permissionAttribute.name]" ng-change="checkDependencies(model)" ng-init="checkDependencies(model)" ng-disabled="permissionDisabled(model, permissionAttribute.name)">\r\n				 </td>\r\n				 </tr>\r\n				 \r\n				 </table>\r\n				 \r\n				 </div>				\r\n				 \r\n				 </div>\r\n				 <div class="modal-footer">\r\n				 <button class="btn btn-primary" ng-click="ok()">{{"OK" | t}}</button>\r\n				 <button class="btn btn-default" ng-click="cancel()">{{"Cancel" | t}}</button>\r\n				 \r\n				 </div>\r\n				 </div>');var ShareModal=function(permissionAttributes,modelName){this.modelName=modelName,this.permissionAttributes=permissionAttributes,this.store=new Store("Intermesh/auth/role/getPermissions",new Model("role"),{modelId:0,modelName:modelName})};return ShareModal.prototype.ModalInstanceController=function($scope,$modalInstance,shareModal){shareModal.store.reset(),$scope.ok=function(){for(var model,updatedPermissions=[],i=0,c=shareModal.store.items.length;c>i;i++)if(model=shareModal.store.items[i],model.isModified()){for(var record={roleId:model.attributes.id},n=0,c2=shareModal.permissionAttributes.length;c2>n;n++)record[shareModal.permissionAttributes[n].name]=model.attributes.permissions.attributes[shareModal.permissionAttributes[n].name]===!0;updatedPermissions.push(record)}$http.post(Utils.url("Intermesh/auth/role/setPermissions",{modelId:shareModal.store.loadParams.modelId,modelName:shareModal.modelName}),{permissions:updatedPermissions}).success(function(){$modalInstance.close()}.bind(this))},$scope.cancel=function(){$modalInstance.close()};var disabledAttributes={};$scope.checkDependencies=function(role){disabledAttributes[role.attributes.id]=[];var permissionAttributes=role.attributes.permissions.attributes;for(var attr in permissionAttributes)if(permissionAttributes[attr]===!0)for(var permissionDependencies=permissionAttributes.permissionDependencies[attr],i=0,c=permissionDependencies.length;c>i;i++)-1===disabledAttributes[role.attributes.id].indexOf(permissionDependencies[i])&&disabledAttributes[role.attributes.id].push(permissionDependencies[i]),permissionAttributes[permissionDependencies[i]]=!0;$scope.permissionDisabled=function(role,permissionAttribute){return disabledAttributes[role.attributes.id]&&disabledAttributes[role.attributes.id].indexOf(permissionAttribute)>-1}},$scope.shareModal=shareModal},ShareModal.prototype.open=function(modelId){return this.store.loadParams.modelId=modelId,$modal.open({templateUrl:"share-modal.html",controller:this.ModalInstanceController,resolve:{shareModal:function(){return this}.bind(this)}})},ShareModal}]),angular.module("intermesh.core").filter("nl2br",["$sce",function($sce){return function(msg){var msg=(msg+"").replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br />$2");return $sce.trustAsHtml(msg)}}]),angular.module("intermesh.ImageUploadPlaceholder",["ui.bootstrap","intermesh.core"]).directive("imImageUploadPlaceholder",["$templateCache","$http","Utils","Model","$timeout",function($templateCache,$http,Utils,Model,$timeout){return{restrict:"E",scope:{imOnChange:"&?",imImageTempAttribute:"=",imImageAttribute:"=",imReadOnly:"=?",imDeletePermission:"=?"},controller:["$scope","$element","$attrs","$transclude","Utils",function($scope,$element,$attrs,$transclude,Utils){$scope.flowInit={singleFile:!0,target:Utils.url("intermesh/upload/flow/upload")}}],link:function(scope,element,attrs){attrs.imThumbWidth||(attrs.imThumbWidth=150),attrs.imThumbHeight||(attrs.imThumbHeight=150),attrs.imThumbZoomCrop||(attrs.imThumbZoomCrop=1),attrs.imReadOnly||(attrs.imReadOnly=!1),attrs.imAlt||(attrs.imAlt="Image"),attrs.imDefaultImageUrl||(attrs.imDefaultImageUrl=""),attrs.imDeletePermission||(attrs.imDeletePermission=!1),scope.imDeletePermission=attrs.imDeletePermission,scope.createOriginalUrl=function(src,fromTmp){console.log(src);var route=fromTmp?"intermesh/upload/flow/thumb":attrs.imThumbRoute;return Utils.url(route,{w:attrs.imThumbWidth,h:attrs.imThumbHeight,zoomCrop:attrs.imThumbZoomCrop,src:src})},scope.createThumb=function(src,fromTmp){var route=fromTmp?"intermesh/upload/flow/thumb":attrs.imThumbRoute;return Utils.url(route,{w:attrs.imThumbWidth,h:attrs.imThumbHeight,zoomCrop:attrs.imThumbZoomCrop,src:src})},scope.uploadSuccess=function($file,$message){var data=angular.fromJson($message);scope.imImageTempAttribute=data.file,scope.imageUrl=scope.createThumb(data.file,!0),scope.originalUrl=scope.createOriginalUrl(data.file,!0),scope.imOnChange&&$timeout(function(){scope.imOnChange({file:data.file})})},scope.delete=function(){scope.imImageAttribute="",scope.imageUrl=!1},scope.imImageAttribute?(scope.imageUrl=scope.createThumb(scope.imImageAttribute,!1),scope.originalUrl=scope.createOriginalUrl(scope.imImageAttribute,!1)):scope.imageUrl=!1},template:'<div class="im-image-upload-placeholder-container" ng-if="imReadOnly">		<div class="btn btn-primary enlarge" ng-href="{{imageUrl}}" target="_blank">		<span class="fa fa-external-link"></span>	</div>				<img ng-if="imageUrl" ng-src="{{imageUrl}}" alt="{{imAlt}}" />				<i ng-if="!imageUrl" class="fa fa-image"></i></div><div class="im-image-upload-placeholder-container" ng-if="!imReadOnly" 			data-flow-name="uploader.flow" 			ng-attr-flow-init="flowInit" 			data-flow-file-added="!!{png:1,gif:1,jpg:1,jpeg:1}[$file.getExtension()]" 			data-flow-files-submitted="$flow.upload()" 			data-flow-file-success="uploadSuccess($file, $message);" 		>	<div ng-if="imDeletePermission" class="btn btn-danger trash" ng-click="delete($event);">		<span class="fa fa-trash-o"></span>	</div>		<a class="btn btn-primary enlarge" ng-href="{{imageUrl}}" target="_blank">		<span class="fa fa-external-link"></span>	</a>		<div class="thumbnail" data-flow-drop data-flow-btn>				<img ng-if="imageUrl" ng-src="{{imageUrl}}" alt="{{imAlt}}" />				<i ng-if="!imageUrl" class="fa fa-image"></i>			</div>			<div class="progress-bar-container" ng-repeat="file in $flow.files">				<div class="progress progress-striped" ng-class="{active: file.isUploading()}">					<div class="progress-bar" role="progressbar"						 aria-valuenow="{{file.progress() * 100}}"						 aria-valuemin="0"						 aria-valuemax="100"						 ng-style="{width: (file.progress() * 100) + \'%\'}">						<span class="sr-only">{{file.progress()}}% Complete</span>					</div>				</div>			</div>		</div>'}}]),angular.module("intermesh.customFields",["intermesh.data"]).service("CustomFields",["Store","Model",function(Store,Model){var loadedFieldSets={},CustomFields=function(){};return CustomFields.prototype.getFieldSetStore=function(modelName){return loadedFieldSets[modelName]||(loadedFieldSets[modelName]=new Store("Intermesh/customFields/fieldSet/store",new Model("fieldset","Intermesh/customFields/fieldSet/create","Intermesh/customFields/fieldSet/update","Intermesh/customFields/fieldSet/delete"),{returnAttributes:["*","fields"],limit:0,where:{modelName:modelName}}),loadedFieldSets[modelName].load()),loadedFieldSets[modelName]},new CustomFields}]),angular.module("intermesh.customFields").directive("imCustomFieldsEdit",["$templateCache",function($templateCache){return $templateCache.put("customfield-text.html",'<div class="form-group">							<label class="col-sm-3 control-label" for="cf_{{field.attributes.id}}">{{field.attributes.name}}</label>							<div class="col-sm-9"><input id="cf_{{field.attributes.id}}" type="text" maxlength="{{field.attributes.data.maxLength}}" ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]" placeholder="{{field.attributes.placeholder}}" ng-required="field.attributes.required" class="form-control" /></div>						</div>'),$templateCache.put("customfield-textarea.html",'<div class="form-group">							<label class="col-sm-3 control-label" for="cf_{{field.attributes.id}}">{{field.attributes.name}}</label>							<div class="col-sm-9"><textarea msd-elastic="\n" style="height:60px" id="cf_{{field.attributes.id}}" maxlength="{{field.attributes.data.maxLength}}" ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]" placeholder="{{field.attributes.placeholder}}" ng-required="field.attributes.required" class="form-control"></textarea></div>						</div>'),$templateCache.put("customfield-select.html",'<div class="form-group">							<label class="col-sm-3 control-label">{{field.attributes.name}}</label>							<div class="col-sm-9">								<ui-select ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]">											<ui-select-match class="ab-multi-input-select" placeholder="{{field.attributes.placeHolder}}">{{$select.selected.value}}</ui-select-match>											<ui-select-choices repeat="item.value as item in field.attributes.data.options | filter: $select.search">												<div ng-bind-html="item.value | highlight: $select.search"></div>											</ui-select-choices>										</ui-select>							</div>						</div>'),$templateCache.put("customfield-checkbox.html",'<div class="form-group"><div class="checkbox col-sm-offset-3 col-sm-9">			<label>				<input id="cf_{{field.attributes.id}}" type="checkbox" ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]" /> {{field.attributes.name}}			</label>		</div></div>'),$templateCache.put("customfield-date.html",'<div class="form-group">							<label class="col-sm-3 control-label" for="cf_{{field.attributes.id}}">{{field.attributes.name}}</label>							<div class="col-sm-9"><div class="input-group" style="width:300px">								<input id="cf_{{field.attributes.id}}" type="text" class="form-control"  ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]" datepicker-popup="dd-MM-yyyy" is-open="datePickerOpened[field.attributes.id]" close-text="Close" />								<span class="input-group-btn">									<button type="button" class="btn btn-default" ng-click="openDatePicker(field.attributes.id, $event)"><i class="fa fa-calendar"></i></button>								</span>							</div></div>						</div>'),$templateCache.put("customfield-datetime.html","TODO!"),$templateCache.put("customfield-number.html",'<div class="form-group">							<label class="col-sm-3 control-label" for="cf_{{field.attributes.id}}">{{field.attributes.name}}</label>							<div class="col-sm-9"><input im-numeric id="cf_{{field.attributes.id}}" type="text" ng-model="imModel.attributes.customfields.attributes[field.attributes.databaseName]" placeholder="{{field.attributes.placeholder}}" ng-required="field.attributes.required" class="form-control" /></div>						</div>'),{restrict:"E",scope:{imModel:"=",imServerModel:"@"},controller:["$scope","$element","$attrs","$transclude","CustomFields",function($scope,$element,$attrs,$transclude,CustomFields){$scope.customFieldSetStore=CustomFields.getFieldSetStore($attrs.imServerModel),$scope.datePickerOpened={},$scope.openDatePicker=function(id,$event){$event.preventDefault(),$event.stopPropagation(),$scope.datePickerOpened[id]=!0}}],template:'<fieldset ng-repeat="fieldSet in customFieldSetStore.items"><legend>{{fieldSet.attributes.name}}</legend><ng-include ng-repeat="field in fieldSet.attributes.fields" src="\'customfield-\'+field.attributes.type+\'.html\'"></ng-include></fieldset>'}}]).directive("imCustomFieldsDetail",["$templateCache",function($templateCache){return $templateCache.put("customfield-text-detail.html",'<dl class="dl-horizontal" ng-if="imModel.attributes.customfields.attributes[field.attributes.databaseName] != \'\'">							<dt>{{field.attributes.name}}</dt>							<dd>{{imModel.attributes.customfields.attributes[field.attributes.databaseName]}}</dd>						</dl>'),$templateCache.put("customfield-textarea-detail.html",'<dl class="dl-horizontal" ng-if="imModel.attributes.customfields.attributes[field.attributes.databaseName] != null">							<dt>{{field.attributes.name}}</dt>							<dd><pre>{{imModel.attributes.customfields.attributes[field.attributes.databaseName]}}</pre></dd>						</dl>'),$templateCache.put("customfield-select-detail.html",'<dl class="dl-horizontal" ng-if="imModel.attributes.customfields.attributes[field.attributes.databaseName] != \'\'">							<dt>{{field.attributes.name}}</dt>							<dd>{{imModel.attributes.customfields.attributes[field.attributes.databaseName]}}</dd>						</dl>'),$templateCache.put("customfield-checkbox-detail.html",'<dl class="dl-horizontal"  ng-if="imModel.attributes.customfields.attributes[field.attributes.databaseName] != \'\'">							<dt>&nbsp;</dt><dd><i class="fa" ng-class="{\'fa-square-o\': !imModel.attributes.customfields.attributes[field.attributes.databaseName],\'fa-check-square-o\': imModel.attributes.customfields.attributes[field.attributes.databaseName]}"></i> {{field.attributes.name}}</dd>						</dl>'),$templateCache.put("customfield-date-detail.html","<dl class=\"dl-horizontal\" ng-if=\"imModel.attributes.customfields.attributes[field.attributes.databaseName] != ''\">							<dt>{{field.attributes.name}}</dt>							<dd>{{imModel.attributes.customfields.attributes[field.attributes.databaseName] | date:'longDate'}}</dd>						</dl>"),$templateCache.put("customfield-datetime.html","TODO!"),$templateCache.put("customfield-number-detail.html",'<dl class="dl-horizontal" ng-if="imModel.attributes.customfields.attributes[field.attributes.databaseName] != \'\'">							<dt>{{field.attributes.name}}</dt>							<dd>{{imModel.attributes.customfields.attributes[field.attributes.databaseName] | number}}</dd>						</dl>'),{restrict:"E",scope:{imModel:"=",imServerModel:"@"},controller:["$scope","$element","$attrs","$transclude","CustomFields",function($scope,$element,$attrs,$transclude,CustomFields){$scope.customFieldSetStore=CustomFields.getFieldSetStore($attrs.imServerModel),$scope.datePickerOpened={},$scope.openDatePicker=function(id,$event){$event.preventDefault(),$event.stopPropagation(),$scope.datePickerOpened[id]=!0}}],template:'<div ng-repeat="fieldSet in customFieldSetStore.items">							<legend>{{fieldSet.attributes.name}}</legend>								<ng-include ng-repeat="field in fieldSet.attributes.fields" src="\'customfield-\'+field.attributes.type+\'-detail.html\'"></ng-include>							</div>'}}]),angular.module("intermesh.softDeleteButton",["intermesh.data"]).directive("imSoftDeleteButton",[function(){return{restrict:"E",scope:{imModel:"=",imSize:"@",imOnDelete:"&?",imOnUnDelete:"&?"},compile:function(element,attrs){attrs.imSize||(attrs.imSize="xs")},controller:["$scope",function($scope){$scope.delete=function($event){$event.stopPropagation(),$event.preventDefault(),$scope.imModel.delete().then(function(result){$scope.imOnDelete&&$scope.imOnDelete({result:result})})},$scope.unDelete=function($event){$event.stopPropagation(),$event.preventDefault(),$scope.imModel.unDelete().then(function(result){$scope.imOnUnDelete&&$scope.imOnUnDelete({result:result})})}}],template:'<span ng-if="!imModel.attributes.deleted" class="btn btn-{{imSize}} btn-danger im-soft-delete-btn" ng-click="delete($event);" tooltip="{{\'Delete\' | t}}" tooltip-placement="left">						<i class="fa fa-trash-o"></i>					</span>										<span ng-if="imModel.attributes.deleted" class="btn btn-{{imSize}} btn-primary im-soft-delete-btn" ng-click="unDelete($event);" tooltip="{{\'Undo delete\' | t}}" tooltip-placement="left">						<i class="fa fa-undo"></i>					</span>					'}}]),angular.module("intermesh.core").directive("imNumeric",["$filter","$locale",function($filter,$locale){return{restrict:"A",require:"ngModel",link:function(scope,element,attr,ngModel){function theDecimalPlaces(num){var match=(""+num).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return match?Math.max(0,(match[1]?match[1].length:0)-(match[2]?+match[2]:0)):0}function fromUser(text){if(""===text)return null;var x=text.split($locale.NUMBER_FORMATS.GROUP_SEP).join(""),y=x.split($locale.NUMBER_FORMATS.DECIMAL_SEP).join(".");return Number(y)}function toUser(n){return $filter("number")(n,decN)
}element.addClass("im-numeric"),element.bind("focus",function(event){event.target.select()});var decN=scope.$eval(attr.decimalPlaces);ngModel.$parsers.push(fromUser),ngModel.$formatters.push(toUser),element.bind("blur",function(){element.val(toUser(ngModel.$modelValue))}),element.bind("focus",function(){var n=ngModel.$modelValue,formattedN=$filter("number")(n,theDecimalPlaces(n));element.val(formattedN)})}}}]);var IAE=angular.module("IAE",["intermesh.core","intermesh.data","intermesh.infiniteScroll","intermesh.MessageBox","intermesh.MultiSelectList","intermesh.MultiSelectField","intermesh.ShareModal","intermesh.ImageUploadPlaceholder","intermesh.customFields","intermesh.softDeleteButton","intermesh.sidePanel","ui.router","ui.sortable","ui.bootstrap","ui.select","ngTouch","toggle-switch","flow","ngSanitize","monospaced.elastic","IAE.filters","IAE.services","IAE.directives","IAE.controllers"]).config(["$stateProvider","$urlRouterProvider",function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/404"),$stateProvider.state("404",{url:"/404",templateUrl:"partials/404.html"}).state("login",{url:"",templateUrl:"partials/login.html",controller:"LoginController"}).state("start",{url:"/start",templateUrl:"partials/start.html",controller:"StartController"})}]).config(["$httpProvider",function($httpProvider){$httpProvider.defaults.withCredentials=!0,$httpProvider.defaults.useXDomain=!0,localStorage.authorizationToken&&($httpProvider.defaults.headers.common.Authorization="Token "+localStorage.authorizationToken);var interceptor=["$injector","$q",function($injector,$q){function success(response){var authHeader=response.headers("Authorization");if(authHeader){var matches=authHeader.match("Token (.*)");localStorage.authorizationToken=matches[1],delete $injector.get("$http").defaults.headers.common.Authorization}return response}function error(response){var status=response.status;return 403===status?$injector.get("$state").go("login"):$injector.get("MessageBox").alert("Oops, a server error occurred","Error "+status),$q.reject(response)}return function(promise){return promise.then(success,error)}}];$httpProvider.responseInterceptors.push(interceptor)}]).config(["flowFactoryProvider",function(flowFactoryProvider){flowFactoryProvider.defaults={target:"upload.php",permanentErrors:[404,500,501],maxChunkRetries:1,chunkRetryInterval:5e3,simultaneousUploads:4,singleFile:!0}}]).config(["TranslateProvider",function(TranslateProvider){TranslateProvider.setLanguage("nl")}]).config(["$provide",function($provide){$provide.decorator("dateParser",["$delegate",function($delegate){var oldParse=$delegate.parse;return $delegate.parse=function(input,format){return angular.isString(input)&&format?oldParse.apply(this,arguments):input},$delegate}])}]).run(function(){FastClick.attach(document.body)}).config(["uiSelectConfig",function(uiSelectConfig){uiSelectConfig.theme="bootstrap"}]);IAE.value("version","1.0"),IAE.value("title","Intermesh Angular Example"),angular.module("IAE.services",[]),angular.module("IAE.directives",[]),angular.module("IAE.filters",[]),angular.module("IAE.controllers",[]),angular.module("IAE").config(["TranslateProvider",function(TranslateProvider){TranslateProvider.addTranslations("nl",{Yes:"Ja",No:"Nee",Edit:"Bewerken",Delete:"Verwijderen",Cancel:"Annuleren",Save:"Opslaan",Back:"Terug",OK:"OK",Search:"Zoeken",Login:"Inloggen",Username:"Gebruikersnaam",Password:"Wachtwoord","Remember username":"Gebruikersnaam onthouden","Login to GroupOffice":"Inloggen bij GroupOffice","Access denied":"Geen toegang","Are you sure you want to delete '{name}'?":"Weet u zeker dat u '{name}' wilt verwijderen?"})}]),angular.module("IAE").provider("modules",[function(){var modules={};this.addModule=function(id,title,iconCls){var module={id:id,title:title,iconCls:iconCls};modules[id.toLowerCase()]=module},this.$get=[function(){return modules}]}]),angular.module("IAE.filters").filter("bytes",function(){return function(bytes,precision){if(isNaN(parseFloat(bytes))||!isFinite(bytes))return"-";"undefined"==typeof precision&&(precision=1);var units=["bytes","kB","MB","GB","TB","PB"],number=Math.floor(Math.log(bytes)/Math.log(1024));return(bytes/Math.pow(1024,Math.floor(number))).toFixed(precision)+" "+units[number]}}),angular.module("IAE.filters").filter("boolean",["Translate",function(Translate){return function(boolean){return Translate.t(boolean?"Yes":"No")}}]),angular.module("IAE.directives").directive("iaeStoreSearch",function(){return{restrict:"E",scope:{store:"=store"},templateUrl:"partials/store/search.html"}}),angular.module("IAE.controllers").controller("BodyController",["$scope","httpRequestTracker","title",function($scope,httpRequestTracker,title){$scope.hasPendingRequests=function(){},$scope.title=title}]),angular.module("IAE.controllers").controller("StartController",["$scope","$state","modules","$http","Utils","title","Store","Model",function($scope,$state,modules,$http,Utils,title,Store,Model){$scope.modules=modules,$scope.title=title,$scope.logout=function(){delete localStorage.authorizationToken;var url=Utils.url("intermesh/auth/auth/logout");$http.post(url,{ajax:1}).success(function(){$state.go("login")})},$scope.store=new Store("Intermesh/modules/module/store",new Model("module"),{limit:0}),$scope.store.load()}]),angular.module("IAE.controllers").controller("LoginController",["$scope","$http","$state","Utils","MessageBox","Translate",function($scope,$http,$state,Utils,MessageBox,Translate){$scope.master=$scope.user={username:"",password:"",remember:!1},$scope.config={url:Utils.baseUrl||"http://localhost/intermesh-php-example/html/"},$scope.login=function(user){Utils.setBaseUrl($scope.config.url);var url=Utils.url("intermesh/auth/auth/login");$http.post(url,user).success(function(data){data.success?$state.go("start"):MessageBox.alert(Translate.t(data.errors[0]))})},$scope.reset=function(){$scope.user=angular.copy($scope.master)}}]),angular.module("IAE.filters").filter("encodeURIComponent",["$window",function($window){return $window.encodeURIComponent}]),angular.module("IAE.services").factory("httpRequestTracker",["$http",function($http){var httpRequestTracker={};return httpRequestTracker.hasPendingRequests=function(){return $http.pendingRequests.length>0},httpRequestTracker}]),angular.module("IAE.controllers").controller("UserDetailController",["Model","$scope","$state","$stateParams",function(Model,$scope,$state,$stateParams){$scope.user.load($stateParams.userId)}]),angular.module("IAE.controllers").controller("UserEditController",["Model","$scope","$state","$stateParams","Store","$http","Utils","MultiSelectList",function(Model,$scope,$state,$stateParams,Store,$http,Utils,MultiSelectList){$scope.multiSelectList=new MultiSelectList(new Store("intermesh/auth/user/roles",new Model("users"),{userId:$stateParams.userId}),new Store("intermesh/auth/user/availableRoles",new Model("users"),{userId:$stateParams.userId}),"modules/users/partials/multi-select-roles.html",$scope.user,"roles"),$scope.user.loadIf($stateParams.userId).then(function(){$scope.multiSelectList.selectedStore.loadData($scope.user.attributes.roles)}),$scope.cancel=function(){$scope.user.attributes.id?($scope.user.resetAttributes(),$state.go("users.detail",{userId:$scope.user.attributes.id})):$state.go("^")}}]),angular.module("IAE.controllers").controller("UsersController",["$scope","$state","Translate","Store","Model","MessageBox",function($scope,$state,Translate,Store,Model,MessageBox){$scope.pageTitle=Translate.t("User management"),$scope.contentActive=function(){return!$state.is("users")},$scope.store=new Store("intermesh/auth/user/store",new Model("user","intermesh/auth/user/create","intermesh/auth/user/update","intermesh/auth/user/delete")),$scope.store.returnAttributes=["id","username","email","createdAt"],$scope.user=new Model("user","intermesh/auth/user/create","intermesh/auth/user/update","intermesh/auth/user/delete",{returnAttributes:["*","roles"]}),$scope.save=function(){$scope.user.save().success(function(){$scope.store.reload(),$state.go("users.detail",{userId:$scope.user.attributes.id})}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})},$scope.delete=function(name){var confirm=MessageBox.confirm(Translate.t("Are you sure you want to delete '{name}'?").replace("{name}",name));confirm.result.then(function(){$scope.user.delete().success(function(){$scope.store.remove($scope.store.findIndexByAttribute("id",$scope.user.attributes.id)),$state.go("users")}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})})}}]),angular.module("IAE.controllers").controller("RoleEditController",["Model","$scope","$state","$stateParams","Store","$http","Utils","$modal","$log","MultiSelectList",function(Model,$scope,$state,$stateParams,Store,$http,Utils,$modal,$log,MultiSelectList){$scope.role.load($stateParams.roleId),$scope.multiSelectList=new MultiSelectList(new Store("intermesh/auth/role/users",new Model("user"),{roleId:$stateParams.roleId}),new Store("intermesh/auth/role/availableUsers",new Model("user"),{roleId:$stateParams.roleId}),"multiSelectUsers.html",$scope.role,"users")}]),angular.module("IAE.controllers").controller("RolesController",["$scope","$state","Translate","Store","Model","MessageBox",function($scope,$state,Translate,Store,Model,MessageBox){$scope.pageTitle=Translate.t("Role management"),$scope.contentActive=function(){return!$state.is("roles")},$scope.store=new Store("intermesh/auth/role/store",new Model("role","intermesh/auth/role/create","intermesh/auth/role/update","intermesh/auth/role/delete")),$scope.role=new Model("role","intermesh/auth/role/create","intermesh/auth/role/update","intermesh/auth/role/delete"),$scope.save=function(){$scope.role.save().success(function(){$scope.store.reload()}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})},$scope.delete=function(name){var confirm=MessageBox.confirm(Translate.t("Are you sure you want to delete '{name}'?").replace("{name}",name));confirm.result.then(function(){$scope.role.delete().success(function(){$scope.store.remove($scope.store.findIndexByAttribute("id",$scope.role.attributes.id)),$state.go("roles")}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})})}}]),angular.module("IAE.controllers").controller("ApiBrowseController",["Store","$scope","$http","Utils",function(Store,$scope,$http,Utils){$scope.pageTitle="API browser",$http.get(Utils.url("intermesh/apiBrowser/browse/controllers")).success(function(data){console.log(data),$scope.controllers=data.results}),$scope.getParams=[{name:"",value:""}],$scope.json="",$scope.response="",$scope.requestMethod="GET",$scope.setAction=function(action){$scope.response="",$scope.getParams=[];for(var i=0,max=action.getParams.length;max>i;i++)$scope.getParams.push({name:action.getParams[i].name,value:action.getParams[i].defaultValue});$scope.route=action.route},$scope.request=function(requestMethod){var json=""!=$scope.json?angular.fromJson($scope.json):{};console.log(json);for(var params={},i=0;i<$scope.getParams.length;i++)""!==$scope.getParams[i].name&&(params[$scope.getParams[i].name]=$scope.getParams[i].value);"GET"===requestMethod?$http.get(Utils.url($scope.route,params)).success(function(data){$scope.response=data}):$http.post(Utils.url($scope.route,params),json).success(function(data){$scope.response=data})}}]),angular.module("IAE.controllers").controller("ContactDetailController",["Model","$scope","$stateParams","Utils","ShareModal","Store",function(Model,$scope,$stateParams,Utils,ShareModal){$scope.shareModal=new ShareModal([{name:"readAccess",label:"Read"},{name:"editAccess",label:"Edit"},{name:"deleteAccess",label:"Delete"}],"\\IPE\\Modules\\Contacts\\Model\\Contact"),$scope.contact.attributes={},$scope.contact.loadIf($stateParams.contactId).then(function(){$scope.photoUrl=$scope.contact.attributes.photoFilePath?Utils.url("IPE/contacts/contact/thumb",{w:75,h:100,zoomCrop:1,src:$scope.contact.attributes.photoFilePath}):""}).then(function(){var index=$scope.store.findIndexByAttribute("id",$scope.contact.attributes.id);index&&($scope.store.items[index].attributes=$scope.contact.attributes)})}]),angular.module("IAE.controllers").controller("ContactEditController",["$scope","$state","$stateParams","Utils","$sce","Translate","$http","$q",function($scope,$state,$stateParams,Utils,$sce,Translate){var defaultPhotoUrl="";$scope.cancel=function(){$scope.contact.attributes.id?($scope.contact.resetAttributes(),$state.go("contacts.contact",{contactId:$scope.contact.attributes.id})):$state.go("^")},$scope.contact.loadIf($stateParams.contactId).then(function(){$scope.photoUrl=$scope.contact.attributes.photoFilePath?Utils.url("IPE/contacts/contact/thumb",{w:75,h:100,zoomCrop:1,src:$scope.contact.attributes.photoFilePath}):defaultPhotoUrl,$scope.fullName=$scope.contact.attributes.firstName,""!==$scope.contact.attributes.middleName&&($scope.fullName+=" "+$scope.contact.attributes.middleName),""!==$scope.contact.attributes.lastName&&($scope.fullName+=" "+$scope.contact.attributes.lastName)}),$scope.uploader={},$scope.uploadTarget=Utils.url("intermesh/upload/flow/upload"),$scope.photoUrl=defaultPhotoUrl,$scope.hasPhoto=function(){return $scope.photoUrl!==defaultPhotoUrl},$scope.uploadSuccess=function($file,$message){var data=angular.fromJson($message);$scope.contact.attributes.photoTempPath=data.file,$scope.photoUrl=Utils.url("intermesh/upload/flow/thumb",{w:60,h:60,zoomCrop:1,src:data.file})},$scope.removePhoto=function(){$scope.contact.attributes.photoFilePath="",$scope.photoUrl=defaultPhotoUrl,$scope.uploader.flow.cancel()},$scope.addEmailAddress=function(){$scope.contact.attributes.emailAddresses.push({attributes:{type:"work"}})},$scope.addPhoneNumber=function(){$scope.contact.attributes.phoneNumbers.push({attributes:{type:"work,voice"}})},$scope.addAddress=function(){$scope.contact.attributes.addresses.push({attributes:{type:"work"}})},$scope.addDate=function(){$scope.contact.attributes.dates.push({attributes:{type:"anniversary"}})},$scope.emailAddressOptions=[{value:"work",label:Translate.t("Work")},{value:"home",label:Translate.t("Home")},{value:"other",label:Translate.t("Other")}],$scope.phoneNumberOptions=[{value:"work,voice",label:Translate.t("Phone")+" ("+Translate.t("Work")+")"},{value:"work,cell",label:Translate.t("Mobile")+" ("+Translate.t("Work")+")"},{value:"home,voice",label:Translate.t("Phone")+" ("+Translate.t("Home")+")"},{value:"home,cell",label:Translate.t("Mobile")+" ("+Translate.t("Home")+")"}],$scope.dateOptions=[{value:"birthday",label:Translate.t("Birthday")},{value:"anniversary",label:Translate.t("Anniversary")},{value:"other",label:Translate.t("Other")}],$scope.changeFullName=function(){var parts=$scope.fullName.split(" ");$scope.contact.attributes.firstName=parts.shift(),$scope.contact.attributes.middleName=parts.length>1?parts.shift():"",$scope.contact.attributes.lastName=parts.join(" ")},$scope.showNameParts=!1,$scope.dateOpened={},$scope.openDate=function(date,$event){$event.preventDefault(),$event.stopPropagation(),date.isOpen=!0}}]),angular.module("IAE.filters").filter("contactPhoto",["Utils",function(Utils){return function(photoFilePath){return photoFilePath?Utils.url("IPE/contacts/contact/thumb",{w:75,h:100,zoomCrop:1,src:photoFilePath}):"http://www.placehold.it/75x100/EFEFEF/AAAAAA&text=no+image"}}]),angular.module("IAE.controllers").controller("ContactController",["$scope","$state","Translate","Store","Model","MessageBox",function($scope,$state,Translate,Store,Model,MessageBox){$scope.pageTitle=Translate.t("Contacts"),$scope.contentActive=function(){return!$state.is("contacts")},$scope.store=new Store("IPE/contacts/contact/store",new Model("contact","IPE/contacts/contact/create","IPE/contacts/contact/update","IPE/contacts/contact/delete"),{returnAttributes:["id","firstName","middleName","lastName","photoFilePath"]}),$scope.contact=new Model("contact","IPE/contacts/contact/create","IPE/contacts/contact/update","IPE/contacts/contact/delete",{returnAttributes:["*","emailAddresses","phoneNumbers","dates","addresses[*, formatted]","tags","customfields"]}),$scope.save=function(){$scope.contact.save().success(function(){$scope.store.reload(),$state.go("contacts.contact",{contactId:$scope.contact.attributes.id})}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})},$scope.delete=function(name){var confirm=MessageBox.confirm(Translate.t("Are you sure you want to delete '{name}'?").replace("{name}",name));confirm.result.then(function(){$scope.contact.delete().success(function(){$scope.store.remove($scope.store.findIndexByAttribute("id",$scope.contact.attributes.id)),$state.go("contacts")}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})})},$scope.test=function(){console.log("test")}}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("apibrowser","API Browser","fa-database")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("apibrowser",{url:"/apibrowser",templateUrl:"modules/api-browser/partials/main.html",controller:"ApiBrowseController"})}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("contacts","Contacts","fa-book")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("contacts",{url:"/contacts",templateUrl:"modules/contacts/partials/main.html",controller:"ContactController"}).state("contacts.contact",{url:"/contacts/contact/{contactId:[0-9]*}",templateUrl:"modules/contacts/partials/contact-detail.html",controller:"ContactDetailController"}).state("contacts.editContact",{url:"/contacts/editContact/{contactId:[0-9]*}",templateUrl:"modules/contacts/partials/contact-edit.html",controller:"ContactEditController"})}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("roles","Role management","fa-group")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("roles",{url:"/roles",templateUrl:"modules/roles/partials/main.html",controller:"RolesController"}).state("roles.edit",{url:"/roles/edit/{roleId:[0-9]*}",templateUrl:"modules/roles/partials/role-edit.html",controller:"RoleEditController"})}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("users","User management","fa-user")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("users",{url:"/modules/users",templateUrl:"modules/users/partials/main.html",controller:"UsersController"}).state("users.detail",{url:"/users/detail/{userId:[0-9]*}",templateUrl:"modules/users/partials/user-detail.html",controller:"UserDetailController"}).state("users.edit",{url:"/users/edit/{userId:[0-9]*}",templateUrl:"modules/users/partials/user-edit.html",controller:"UserEditController"})}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("customfields","Custom fields","fa-database")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("customfields",{url:"/customfields",templateUrl:"modules/customfields/partials/main.html",controller:"CustomFieldsController"}).state("customfields.model",{url:"/model/{modelName:[^/]*}",templateUrl:"modules/customfields/partials/model.html",controller:"ModelController"}).state("customfields.model.fieldset",{url:"/fieldSet/{fieldSetId:[0-9]*}",controller:"FieldSetController",template:'<div ng-init="openModal()"></div>'}).state("customfields.model.fields",{url:"/fields/{fieldSetId:[0-9]*}",templateUrl:"modules/customfields/partials/fields.html",controller:"FieldsController"}).state("customfields.model.fields.field",{url:"/field/{fieldId:[0-9]*}",controller:"FieldController",template:'<div ng-init="openModal()"></div>'})}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("helloworld","Hello world","fa-thumbs-o-up")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("helloworld",{url:"/helloworld",templateUrl:"modules/helloworld/partials/main.html"})}]),angular.module("IAE.controllers").controller("CustomFieldsController",["$scope","$state","$http","Translate","Utils",function($scope,$state,$http,Translate,Utils){$scope.pageTitle=Translate.t("Custom fields"),$scope.models=[],$scope.$state=$state,$http.get(Utils.url("intermesh/customFields/model/getModelNames")).then(function(response){$scope.models=response.data.results})}]),angular.module("IAE.controllers").controller("ModelController",["$scope","$stateParams","Store","Model","$state",function($scope,$stateParams,Store,Model,$state){$scope.modelName=$stateParams.modelName,$scope.$state=$state,$scope.fieldSetStore=new Store("Intermesh/customFields/fieldSet/store",new Model("fieldset","Intermesh/customFields/fieldSet/create","Intermesh/customFields/fieldSet/update","Intermesh/customFields/fieldSet/delete"),{limit:0,where:{modelName:$scope.modelName}}),$scope.fieldSetStore.load(),$scope.dragControlListeners={orderChanged:function(){$scope.fieldSetStore.saveSortOrder("Intermesh/CustomFields/FieldSet/SaveSort")}},$scope.fieldStore=new Store("Intermesh/customFields/field/store",new Model("field","Intermesh/customFields/field/create","Intermesh/customFields/field/update","Intermesh/customFields/field/delete"),{limit:0}),$scope.onDelete=function(){$state.go("customfields.model",$stateParams)}}]),angular.module("IAE.controllers").controller("FieldsController",["$scope","$stateParams","Store","Model",function($scope,$stateParams){$scope.fieldStore.reset(),$scope.fieldStore.load({where:{fieldSetId:$stateParams.fieldSetId}}),$scope.dragControlListeners={orderChanged:function(){$scope.fieldStore.saveSortOrder("Intermesh/CustomFields/Field/SaveSort")}}}]),angular.module("IAE.controllers").controller("FieldController",["$scope","$modal","$state","$stateParams",function($scope,$modal,$state){$scope.openModal=function(){$modal.open({templateUrl:"modules/customfields/partials/field.html",controller:"FieldModalController",resolve:{fieldStore:function(){return $scope.fieldStore}}}).result.then(function(result){return result?($scope.fieldStore.reload(),$state.go("^")):void 0},function(){return $state.go("^")})}}]).controller("FieldModalController",["$scope","Model","MessageBox","Translate","$stateParams","$state","fieldStore",function($scope,Model,MessageBox,Translate,$stateParams,$state,fieldStore){var field=fieldStore.findModelByAttribute("id",$stateParams.fieldId);$scope.field=field?field:new Model("field","intermesh/customFields/field/create","intermesh/customFields/field/update","intermesh/customFields/field/delete"),$scope.field.loadIf($stateParams.fieldId).then(function(){$scope.field.attributes.data||($scope.field.attributes.data={}),$scope.field.attributes.data.options||($scope.field.attributes.data.options=[])}),$scope.customFieldTypes=[{value:"text",label:"Text field"},{value:"textarea",label:"Text area"},{value:"select",label:"Select"},{value:"checkbox",label:"Check box"},{value:"date",label:"Date"},{value:"datetime",label:"Date & time"},{value:"number",label:"Number"}],$scope.save=function(){$scope.field.save({fieldSetId:$stateParams.fieldSetId}).success(function(result){$scope.$close(result)}).error(function(result){for(var attributeName in result.validationErrors)MessageBox.alert(Translate.t(result.validationErrors[attributeName].code))})},$scope.cancel=function(){$scope.field.attributes.id&&$scope.field.resetAttributes(),$scope.$dismiss()}}]),angular.module("IAE.controllers").controller("NoteController",["$modal","$scope","$state","$timeout","Translate","Store","Model","ShareModal","MessageBox","Utils",function($modal,$scope,$state,$timeout,Translate,Store,Model,ShareModal,MessageBox){$scope.pageTitle=Translate.t("Notes"),$scope.contentActive=function(){return!$state.is("notes")},$scope.store=new Store("IPE/Notes/Note/store",new Model("note","IPE/Notes/Note/create","IPE/Notes/Note/update","IPE/Notes/Note/delete")),$scope.dragControlListeners={accept:function(){return!0},itemMoved:function(){},orderChanged:function(){$scope.store.saveSortOrder("IPE/Notes/Note/saveSort")}},$scope.note=new Model("note","IPE/Notes/Note/create","IPE/Notes/Note/update","IPE/Notes/Note/delete"),$scope.note.attributes.color="yellow",$scope.shareModal=new ShareModal([{name:"readAccess",label:"Read"},{name:"editAccess",label:"Edit"},{name:"deleteAccess",label:"Delete"}],"\\IPE\\Modules\\Notes\\Model\\Note"),$scope.editNote=function(note){$state.go("notes.edit",{noteId:note.attributes.id})},$scope.openPermissionsDialog=function(note){note.currentUserCanManagePermissions&&$scope.shareModal.open(note.attributes.id)},$scope.setColor=function(note,color,save){note.attributes.color=color,save&&note.save()},$scope.listItemClick=function(listItem,note,save){listItem.attributes.checked=!listItem.attributes.checked,save&&note.save()},$scope.delete=function(note){if(note.permissions.deleteAccess){var storeIndex=$scope.store.findIndexByAttribute("id",note.attributes.id);MessageBox.confirm("Do you really want to delete this note?","Delete").result.then(function(){note.delete().success(function(){$scope.store.remove(storeIndex)}).error(function(data){for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})})}}}]),angular.module("IAE.controllers").controller("NoteEditController",["$modal","$scope","$state","Translate","Model","MessageBox","$stateParams","Utils",function($modal,$scope,$state,Translate,Model,MessageBox,$stateParams){$scope.note.load($stateParams.noteId),$scope.cancel=function(){$scope.note.resetAttributes(),$state.go("^")},$scope.save=function(){console.log($scope.note.attributes.id);var isNew=!$scope.note.attributes.id;$scope.note.save().success(function(result){if(isNew)$scope.store.items.unshift(result.model);else{var note=$scope.store.findModelByAttribute("id",$scope.note.attributes.id);note.loadData(result.model)}$scope.store.saveSortOrder("IPE/Notes/Note/saveSort"),$state.go("^")}).error(function(data){console.log(data);for(var attributeName in data.modelData.validationErrors)MessageBox.alert(Translate.t(data.modelData.validationErrors[attributeName].code))})},$scope.newImage=function(){var imageModel=new Model("noteImage","IPE/Notes/NoteImage/create","IPE/Notes/NoteImage/update","IPE/Notes/NoteImage/delete");$scope.note.attributes.images.push(imageModel)},$scope.newListItem=function(note){var listItemModel=new Model("noteListItem","IPE/Notes/NoteListItem/create","IPE/Notes/NoteListItem/update","IPE/Notes/NoteListItem/delete");listItemModel.attributes={id:0,noteId:note.attributes.id,text:"",checked:0,sortOrder:note.attributes.listItems.length+1},$scope.note.attributes.listItems.push(listItemModel)}}]),angular.module("IAE").config(["modulesProvider",function(modulesProvider){modulesProvider.addModule("notes","Notes","fa-edit")}]).config(["$stateProvider",function($stateProvider){$stateProvider.state("notes",{url:"/Notes",templateUrl:"modules/notes/partials/main.html",controller:"NoteController"}).state("notes.edit",{url:"/Notes/edit/{noteId:[0-9]*}",templateUrl:"modules/notes/partials/note-edit.html",controller:"NoteEditController"})}]),angular.module("IAE.controllers").controller("FieldSetController",["$scope","$modal","$state","$stateParams",function($scope,$modal,$state){$scope.openModal=function(){$modal.open({templateUrl:"modules/customfields/partials/field-set.html",controller:"FieldSetModalController",resolve:{fieldStore:function(){return $scope.fieldStore}}}).result.then(function(result){return result?($scope.fieldStore.reload(),$state.go("^")):void 0},function(){return $state.go("^")})}}]).controller("FieldSetModalController",["$scope","Model","MessageBox","Translate","$stateParams","$state","fieldStore",function($scope,Model,MessageBox,Translate,$stateParams,$state,fieldStore){var fieldset=fieldStore.findModelByAttribute("id",$stateParams.fieldSetId);fieldset?$scope.fieldset=fieldset:($scope.fieldset=new Model("fieldset","intermesh/customFields/fieldSet/create","intermesh/customFields/fieldSet/update","intermesh/customFields/fieldSet/delete"),$scope.fieldset.load($stateParams.fieldSetId)),$scope.save=function(){$scope.fieldset.save({modelName:$stateParams.modelName}).success(function(result){$scope.$close(result)}).error(function(result){for(var attributeName in result.validationErrors)MessageBox.alert(Translate.t(result.validationErrors[attributeName].code))})},$scope.cancel=function(){$scope.fieldset.attributes.id&&$scope.fieldset.resetAttributes(),$scope.$dismiss()}}]);